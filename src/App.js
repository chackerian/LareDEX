    ...
    <div className="App">
      ...
      <Router>
          <header className="NavBar">
            ...
            <ul id="nav">
              <li><Link to="/about">Ecosystem</Link></li>
          ...
          <div className="dex">
              ...
              <div className="sideNavDiv">
                <p className="sideNav">LARE DEX</p>
                <p className="sideNav">Menu</p>
